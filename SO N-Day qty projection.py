...
if so_file:
    ...
    with tab2:
        ...
        **Demand Forecast assumptions:**  
        ...
        st.markdown("<h4 style="color: maroon;">Predicted SO Qty for Next Week</h4>", unsafe_allow_html=True)
        ...
        st.markdown("<h4style="color: maroon;">Summary by WH by Day</h4>", unsafe_allow_html=True)
